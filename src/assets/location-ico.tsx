export default function LocationIcon({ width = 200, height = 200, color = "#ffffff" }: { width?: number, height?: number, color?: string }) {
    return (
        <svg 
            width={width} 
            height={height} 
        ...
        >
            ...
            <g id="SVGRepo_iconCarrier"> 
                ...
                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"> 
                    <g id="Icon-Set" transform="translate(-104.000000, -411.000000)" fill={color}> 
