export default function LikeIco({ rotate = 0, width = 24, height = 24, fillColor = "#0F0F0F" }: { rotate: number, width?: number, height?: number, fillColor?: string }) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
            ...
            width={width}
            height={height}
            style={{ transform: `rotate(${rotate}deg)`, width: 'fit', height: 'fit' }}
        >
